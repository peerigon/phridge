...
var NewLinesStream = require("./newLinesStream");
...
function prepareChildProcess(childProcess) {
    var stdoutFork = forkStdout();
    var linerstream = new Linerstream();
    var newLines = new NewLinesStream()

    childProcess.stdout
        .pipe(linerstream)
        .pipe(stdoutFork);
    childProcess.cleanStdout = stdoutFork.other.pipe(newLines);
